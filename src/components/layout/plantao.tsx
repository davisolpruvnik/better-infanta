...
export default function Plantao() {
  ...
  return (
    <div className="w-full bg-red-950 border-b border-red-900/40 text-[10px] font-axis-book uppercase tracking-wider text-red-200/80 py-1.5 px-3 sm:px-6 select-none transition-all duration-300 relative overflow-hidden">
      ...
      {/* Main Flex Wrapper (Symmetry matched to Timekeeper's max-6xl) */}
      <div className="relative z-10 w-full max-w-6xl mx-auto flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          ...
          {/* Hidden on extremely narrow devices (under 370px) to guarantee no clipping */}
          <span className="hidden min-[370px]:inline-block font-axis-bold text-red-100 text-[10px] tracking-widest">
            HOTLINES
          </span>
        </div>
              ...
              return (
                ...
                >
                  <a
                    ...
                    className="flex items-center gap-1.5 sm:gap-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded px-2 py-1.5 sm:py-1 w-full transition-colors duration-200 justify-between group"
                  ...
                  >
                    <div className="flex items-center gap-1.5 sm:gap-2 overflow-hidden">
                      ...
                      <span className="truncate text-[10px] text-red-200 group-hover:text-white transition-colors max-w-[65px] sm:max-w-none">
                        {item.agency}
                      </span>
                    </div>
        ...
        {/* 🕹️ Responsive Tiny Manual Chevron Controllers & Link */}
        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0 border-l border-red-900/60 pl-2 sm:pl-3">
          {/* Chevron Navigation with optimized mobile touch target buttons */}
          <div className="flex items-center gap-0.5">
            <button
              onClick={handlePrev}
              className="h-6 w-6 sm:h-7 sm:w-7 flex items-center justify-center hover:bg-white/10 rounded-full text-red-400 hover:text-white transition-colors cursor-pointer"
          ...
          {/* Navigation Link (Responsive sizing and margin adjustments) */}
          <a
            href="/safety"
            className="flex items-center gap-1 shrink-0 rounded bg-white/5 hover:bg-white/10 px-1.5 sm:px-2.5 py-1 text-[9px] sm:text-[10px] font-axis-bold tracking-wider text-red-100 hover:text-white transition-all duration-200 cursor-pointer"
          >
            More
          </a>
        </div>
